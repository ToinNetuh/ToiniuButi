              ...
              await client.sendMessage(from, options, text)
               break
				...
				case 'snowwrite':
					...
					var gbl7 = gh.split("|")[0];
					var gbl8 = gh.split("|")[1];
					if (args.length < 1) return reply(`Kirim perintah ${prefix}snowwrite teks1|teks2, Exemplo ${prefix}snowwrite aqulzz|galuh`)
                                        /*if (!isDaftar) return reply(mess.only.daftarB)*/
					reply(mess.wait)
				...
				case 'marvellogo':
					...
					var gbl5 = gh.split("|")[0];
					var gbl6 = gh.split("|")[1];
					if (args.length < 1) return reply(`Kirim perintah ${prefix}marvellogo teks1|teks2, Exemplo ${prefix}marvellogo aqulzz|galuh`)
                                        /*if (!isDaftar) return reply(mess.only.daftarB)*/
					reply(mess.wait)
	    ...
	    case 'kapankah':
            ...
            break
					...
					case 'lionlogo':
							...
							if (args.length < 1) return reply(`Digite Assim\nExemplo: ${prefix}lionlogo Toin|Bot`)
							reply(mess.wait)
				...
				case 'logowolf2':
					...
					var teks1 = gh.split("|")[0];
					var teks2 = gh.split("|")[1];
					if (args.length < 1) return reply(`teksnya mana? Exemplo ${prefix}logowolf Toin|Bot`)
                                        if (!isUser) return reply(mess.only.daftarB)
					reply(mess.wait)
					...
					if (args.length < 1) return reply(`Parameter Salah\nCommand : ${prefix}daftar nama|umur\nExemplo : ${prefix}daftar Caliph|12`)
